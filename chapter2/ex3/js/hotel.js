...
(function(){
    ...
    roomRate.textContent = '$' + hotel.roomRate.toFixed(2); // Write room rate with 2 decimal numbers
    ...
    function offerExpires(today) {
        ...
        // Add 7 days time (added in miliseconds)
        weekFromToday = new Date(today.getTime() + 7 * 24 * 60 * 60 * 1000);

        // Creates arrays to hold the names of days
        dayNames = ['Sunday','Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];

         // Creates arrays to hold the names of months
